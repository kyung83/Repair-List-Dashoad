...
const links=[{href:"/shop",label:"Shop Jobs"},{href:"/",label:"Repair Board",exact:true},{href:"/work-orders",label:"Work Orders"},{href:"/equipment",label:"Equipment"},{href:"/pm-schedules",label:"PM Schedules"},{href:"/inventory",label:"Inventory"},{href:"/invoices",label:"Invoices"},{href:"/reports",label:"Reports",exact:true},{href:"/reports/history",label:"RO History"}] as const;
