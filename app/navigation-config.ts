...
const allRoles: Role[] = ["viewer", "mechanic", "dispatch", "manager", "admin"];
const todayRoles: Role[] = ["viewer", "mechanic", "manager", "admin"];
...
const sidebarGroups: SidebarGroup[] = [
  {
    ...
    href: "/",
    roles: todayRoles,
    links: [{ href: "/", label: "Today", exact: true, roles: todayRoles }],
  },
  {
    key: "repairs",
    label: "Repairs",
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/inventory-controls", label: "Transfer & Cross-Refs", exact: true, roles: managerRoles },
