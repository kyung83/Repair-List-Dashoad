...
export default function ShopPage(){
  ...
  async function handoffUnit(){const note=handoffNote.trim();if(!note){setMessage("Enter what is left to do for the next shift.");return}const result=await action({action:"doneUnit",handoff:true,targetTechnicianId:handoffTechId?Number(handoffTechId):null,handoffNote:note});if(result){setNeedPart(false);setHandoffOpen(false);setHandoffTechId("");setHandoffNote("")}}
