...
type User={role:"viewer"|"mechanic"|"manager"|"admin";yard?:""|"clare"|"cadillac";yardAssigned?:boolean};
...
export default function YardScopeBanner(){
  ...
  if(!yard)return <section style={{margin:"18px 34px 0",padding:14,border:"2px solid #c94738",borderRadius:12,background:"#fff4f2",color:"#4d1d17"}}>
    ...
    <span style={{display:"block",marginTop:4,fontSize:13}}>An administrator needs to assign Clare or Cadillac in Users &amp; Access. Your already assigned jobs can still be shown, but unassigned yard work cannot be picked up until a yard is set.</span>
  </section>;

  const label=yard==="clare"?"Clare":"Cadillac";
