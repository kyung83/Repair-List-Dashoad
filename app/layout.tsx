...
export const metadata: Metadata = {
  ...
  description: "Fleet repair, direct Geotab DVIR, PM, equipment, and inventory operations for Norloworld.",
  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        <div style={{ position: "fixed", right: 18, bottom: 18, zIndex: 40, display: "flex", gap: 8 }}>
