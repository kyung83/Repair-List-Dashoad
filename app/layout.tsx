...
export const metadata: Metadata = {
  ...
  description: "Fleet repair, direct Geotab DVIR, PM, equipment, work orders, inventory, reporting and ownership-cost operations for Norloworld.",
    ...
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        <div style={{ position: "fixed", right: 18, bottom: 18, zIndex: 40, display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end", maxWidth: "calc(100vw - 36px)" }}>
          ...
          <a href="/reports" style={{ padding: "10px 14px", borderRadius: 999, background: "#6d28d9", color: "white", textDecoration: "none", fontWeight: 800, boxShadow: "0 6px 20px #0003" }}>Reports</a>
