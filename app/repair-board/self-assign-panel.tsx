  ...
  return <section style={panel}>
    <div style={{display:"flex",justifyContent:"space-between",gap:16,alignItems:"flex-end",flexWrap:"wrap"}}>
      <div>
        ...
        <p style={{margin:0,color:"#687786",fontSize:13}}>Claim an unassigned Repair Board item, then work it from Shop Jobs. Your existing clearance stays unchanged.</p>
      </div>
...
const grid={display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(290px,1fr))",gap:10,marginTop:14} as const;
