...
export default function BreakdownReportsPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f3f5f7", color: "#172033", padding: "34px 34px 110px" }}>
      ...
      {data.permissions.canDeleteRecords && <div style={{ ...panel, marginTop: 12, borderColor: "#fed7aa", background: "#fffaf3" }}><strong>Manager tools:</strong> Completed breakdowns can be corrected from the Detail table without reopening them. Edit the final outside invoice total, provider, invoice details, or closeout notes. Test records can still be permanently deleted; records with applied inventory activity are blocked until the stock operation is undone.</div>}
