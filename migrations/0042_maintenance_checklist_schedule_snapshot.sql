...
DROP TRIGGER IF EXISTS trg_require_maintenance_checklist_before_complete;
...
CREATE TRIGGER trg_require_maintenance_checklist_before_complete
...
BEGIN
  ...
  SET status = 'completed',
      completed_by_user_id = COALESCE(completed_by_user_id, ready_by_user_id),
