...
-- Snapshotting and answer/proof validation intentionally live in the Worker rather
-- than D1 triggers. The deploy bootstrap rewrites this still-unapplied migration
-- from remote schema state so a partially applied 0138 can be retried safely.
